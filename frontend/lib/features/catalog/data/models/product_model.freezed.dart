...
@override
String toString() {
  return 'ProductModel(id: $id, sku: $sku, name: $name, price: $price, currency: $currency, stock: $stock)';
}
...
class _ProductModel implements ProductModel {
  const _ProductModel({required this.id, required this.sku, required this.name, required this.price, required this.currency, required this.stock});
